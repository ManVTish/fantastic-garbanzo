...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference("Journey.count") do
      post journeys_url, params: { journey: { destination: @journey.destination, distance: @journey.distance, origin: @journey.origin } }
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { destination: @journey.destination, distance: @journey.distance, origin: @journey.origin } }
